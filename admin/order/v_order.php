	    ...
	    <div class="col-xs-12">
	      <div class="box">
	       <div class="box-header">
              <h1 class="box-title">Data Order Konsumen</h1>
            </div>  
	      </div>
      	</div>
      </div>
                ...
                <?php
                 ...
                 while ($order = mysql_fetch_array($sql, MYSQL_ASSOC)) {
                    ...
                    ?>
                      ...
                      <td>
                        <a href="index.php?page=detail_order&id=<?php echo $order['id_order'];?>" class="btn btn-primary">Detail</a>
                       <?php if($order['status_order'] <= 1 ){?>
                        <a href="order/proses_request_produksi.php?id=<?php echo $order['id_order'];?>" class="btn btn-primary">Kirim Ke Produksi</a>
                        <?php }?>
                      </td>
                    </tr>
                 <?php $no++; }
